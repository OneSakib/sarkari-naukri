import { Search, Bell, FileText, Award, BookOpen, ExternalLink, Clock } from "lucide-react"
      ...
      <section className="bg-blue-600 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-white mb-4">Find Your Dream Government Job</h1>
            <p className="text-blue-100 mb-6">Search from thousands of latest government job notifications</p>
            <div className="max-w-2xl mx-auto flex gap-2">
              <div className="flex-1 relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5" />
                <Input placeholder="Search jobs, admissions, results..." className="pl-10 h-12 text-lg" />
              </div>
