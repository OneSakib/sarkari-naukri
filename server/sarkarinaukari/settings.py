"""
Django settings for sarkarinaukari project.
...
ENCRYPTION_SECRECT_KEY = 'sarkarinaukari'
...
ROOT_URLCONF = 'sarkarinaukari.urls'
...
WSGI_APPLICATION = 'sarkarinaukari.wsgi.application'
